...
<template>
  <StaticPage>
    ...
    <article class="leading-relaxed border-b border-gray-200 pb-8">
      ...
      dan sekitarnya dalam menghadapi perubahan ini dengan percaya diri dan berdaya saing. Kami merangkul pengalaman dan pengetahuan tenaga pengajar kami untuk menciptakan lingkungan pembelajaran yang mendalam dan inspiratif. Kami
      menghubungkan dunia pendidikan dengan tuntutan dunia kerja saat ini dan mendatang, sehingga peserta kursus kami siap menghadapi tantangan global. Terima kasih telah mengunjungi halaman tentang Kalleria Group. Kami berharap dapat
      berkolaborasi dengan Anda dalam perjalanan menuju pengembangan diri yang berkelanjutan dan masa depan yang lebih baik. Jangan ragu untuk menghubungi kami melalui kontak yang telah kami sediakan untuk informasi lebih lanjut.
      <br />
      <br />
      Salam hormat, Tim Kalleria Group
    </article>
  </StaticPage>
</template>
