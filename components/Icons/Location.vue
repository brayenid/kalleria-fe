<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-500" viewBox="0 0 24 24">
    <g fill="currentColor">
      ...
      ></path>
      <path
        d="M9.247 6.61A4.134 4.134 0 0 1 9 6.657v14c.67-.104 1.269-.503 2.442-1.285l1.382-.922c.936-.624 1.404-.936 1.93-1.06c.08-.02.163-.035.246-.047v-14c-.67.103-1.269.503-2.442 1.284l-1.382.922c-.936.624-1.404.936-1.93 1.06Zm8.234 11.217l.254.084l-.254-.084Z"
      ></path>
    </g>
  </svg>
</template>
