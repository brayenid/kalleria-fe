  ...
  <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-500" viewBox="0 0 24 24">
    <g fill="currentColor">
      <path
        ...
        opacity=".5"
      ></path>
      <path d="M10.123 7.271a2.017 2.017 0 1 1-2.852 2.852a2.017 2.017 0 0 1 2.853-2.852Zm8.928 4.78l-6.979 6.98a.75.75 0 1 1-1.06-1.06l6.979-6.98a.75.75 0 1 1 1.06 1.06Z"></path>
    </g>
  </svg>
</template>
